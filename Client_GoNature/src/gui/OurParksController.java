...
/**
 * OurParksController is a controller of OurParks.fxml FXML.
 * The controller implements all the functionals of OurParks.fxml 
 * @author Stav Anna
 *
 */
public class OurParksController
{
	/**
	...
	{
		Parent root = FXMLLoader.load(getClass().getResource("/gui/OurParks.fxml"));
